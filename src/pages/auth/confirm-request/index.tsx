  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <AiFillCheckCircle className="w-14 h-14 sm:w-16 sm:h-16 text-blue-600 flex-shrink-0" />
          ...
          <p className="text-normal sm:text-lg text-gray-500 mt-6">
            ...
            <Link className="text-blue-500 hover:underline hover:text-blue-600" href="/">
              this link
            </Link>
